...
public class BookData {
    ...
    private String[] allColumns = { MySQLiteHelper.COLUMN_ID,
            ...
            MySQLiteHelper.COLUMN_YEAR, MySQLiteHelper.COLUMN_CATEGORY, MySQLiteHelper.COLUMN_PERSONAL_EVALUATION};
    ...
    public Book createBook(Book book) {
        ...
        Log.d("Creating", "Creating " + book.getTitle() + " " + book.getAuthor());
        ...
        if (book.getPublisher().equals(""))values.put(MySQLiteHelper.COLUMN_PUBLISHER, "Desconeguda");
        else values.put(MySQLiteHelper.COLUMN_PUBLISHER, book.getPublisher());
        if (book.getYear() == 0000) values.put(MySQLiteHelper.COLUMN_YEAR, 0000);
        else values.put(MySQLiteHelper.COLUMN_YEAR, book.getYear());
        if (book.getCategory().equals("")) values.put(MySQLiteHelper.COLUMN_CATEGORY, "Sense definir");
        else values.put(MySQLiteHelper.COLUMN_CATEGORY, book.getCategory());
        if (book.getPersonal_evaluation() == null) values.put(MySQLiteHelper.COLUMN_PERSONAL_EVALUATION, "Regular");
        else values.put(MySQLiteHelper.COLUMN_PERSONAL_EVALUATION, book.getPersonal_evaluation());
    ...
    public Book createBook(String title, String author, String valoration) {
        ContentValues values = new ContentValues();
        ...
        if (valoration == null) values.put(MySQLiteHelper.COLUMN_PERSONAL_EVALUATION, "regular");
        else values.put(MySQLiteHelper.COLUMN_PERSONAL_EVALUATION, valoration);
